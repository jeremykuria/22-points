...
describe('Points e2e test', () => {
    ...
    it('should load Points', async () => {
        ...
        expect(await pointsComponentsPage.getTitle()).to.eq('twentyTwoPointsApp.points.home.title');
    });
    ...
    it('should load create Points page', async () => {
        ...
        expect(await pointsUpdatePage.getPageTitle()).to.eq('twentyTwoPointsApp.points.home.createOrEditLabel');
    ...
    it('should delete last Points', async () => {
        ...
        expect(await pointsDeleteDialog.getDialogTitle()).to.eq('twentyTwoPointsApp.points.delete.question');
