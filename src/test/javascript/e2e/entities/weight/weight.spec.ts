...
describe('Weight e2e test', () => {
    ...
    it('should load Weights', async () => {
        ...
        expect(await weightComponentsPage.getTitle()).to.eq('twentyTwoPointsApp.weight.home.title');
    });
    ...
    it('should load create Weight page', async () => {
        ...
        expect(await weightUpdatePage.getPageTitle()).to.eq('twentyTwoPointsApp.weight.home.createOrEditLabel');
    ...
    it('should create and save Weights', async () => {
        ...
        expect(await weightUpdatePage.getDateInput()).to.eq('2000-12-31');
    ...
    it('should delete last Weight', async () => {
        ...
        expect(await weightDeleteDialog.getDialogTitle()).to.eq('twentyTwoPointsApp.weight.delete.question');
